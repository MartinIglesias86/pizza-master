...
window.OverworldMaps = {
    DemoRoom: {
        id: "DemorRoom",
        lowerSrc: "pizza-master/images/maps/DemoLower.png",
        upperSrc: "pizza-master/images/maps/DemoUpper.png",
        gameObjects: {
            hero: new Person({
    ...
    Kitchen: {
        id: "Kitchen",
        lowerSrc: "pizza-master/images/maps/KitchenLower.png",
        upperSrc: "pizza-master/images/maps/KitchenUpper.png",
        gameObjects: {
            hero: new Person({
                isPlayerControlled: true,
                x: utils.withGrid(5),
            ...
            npcB: new Person({
                x: utils.withGrid(10),
                y: utils.withGrid(8),
                src: "pizza-master/images/characters/people/npc3.png",
                talking: [
                    {
                        events: [
    ...
    Street: {
        id: "Street",
        lowerSrc: "pizza-master/images/maps/StreetLower.png",
        upperSrc: "pizza-master/images/maps/StreetUpper.png",
        gameObjects: {
            hero: new Person({
            isPlayerControlled: true,
            x: utils.withGrid(30),
