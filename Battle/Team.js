    ...
    createElement() {
        ...
        this.combatants.forEach(c => {
            ...
            icon.innerHTML = (`
                ...
                <!-- El indicador de pizza activa aparece cuando es necesario con CSS -->
                <path class="active-pizza-indicator" stroke="#3a160d" d="M3 8h1M2 9h3" />
            
                <!-- Cuando una pizza muere aparecen los dead path con overlay en CSS -->
